...
class FlightsSearchAgentBuilder:
    ...
    async def flightsSearchTool(self, query: str) -> str:
        print("Flights Search Agent in action .......")
        ...
        agent = project_client.agents.create_agent(
                ...
                instructions="""        
                    ...
                    Your only tool is search_tool - use it to find flights.
                    Once you have the results, you never do calculations based on them.
                    Return address for every flights.
                """,
    ...
    def getAgent(self):
        return AssistantAgent(
            name="flights_search_agent",
            model_client=self.modelClient,
            tools=[self.flightsSearchTool],
            system_message="You are a flights search expert, help me use tools to find flights",
        )